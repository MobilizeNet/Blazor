...
namespace SKS_Blazor.Components
{
    partial class frmRequestApproval
    {
        ...
        private void InitializeComponent()
        {
            ...
            //txtProductID.Cursor = Cursors.IBeam; /gap-todo: PBI 745731: [Blazor][DemoConversion][Controls] Add support for Control Cursor property
            ...
            //txtOrderID.Cursor = Cursors.IBeam; //gap-todo: PBI 745731: [Blazor][DemoConversion][Controls] Add support for Control Cursor property
            ...
            //txtContactLastName.Cursor = Cursors.IBeam; //gap-todo: PBI 745731: [Blazor][DemoConversion][Controls] Add support for Control Cursor property
            ...
            //txtContactName.Cursor = Cursors.IBeam; //gap-todo: PBI 745731: [Blazor][DemoConversion][Controls] Add support for Control Cursor property
            ...
            //txtCompanyName.Cursor = Cursors.IBeam; //gap-todo: PBI 745731: [Blazor][DemoConversion][Controls] Add support for Control Cursor property
            ...
            Text = "Create Invoice";
            //commandButtonHelper1.SetStyle(cmdApprove, 0); //gap-todo
            //commandButtonHelper1.SetStyle(cmdInfo, 0); //gap-todo
            //commandButtonHelper1.SetStyle(cmdCancel, 0); //gap-todo
            //commandButtonHelper1.SetStyle(cmdClose, 0); //gap-todo
            //commandButtonHelper1.SetStyle(cmdCustomers, 0); //gap-todo
            //listBoxComboBoxHelper1.SetItemData(cmbStatus, new int[] { 0, 0, 0, 0 }); //gap-todo
        ...
        void ReLoadForm(bool addEvents)
        {
            ...
            // child's parent.
            MdiParent = frmMain.DefInstance; //gap-todo
