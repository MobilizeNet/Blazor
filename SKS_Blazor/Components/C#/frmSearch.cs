namespace SKS_Blazor.Components
{
    ...
    public partial class frmSearch : Form
    {
        ...
        //''
        public async void SearchCriteriaCustomers(string field, string value)
        {
            ...
            else
            {
                ...
                frmCustomers.DefInstance.dcCustomers.RecordSource = modConnection.RecordSource;//gap-note line added due to Binding Source change
                frmCustomers.DefInstance.VB6_AddADODataBinding(true);//gap-note line added due to Binding Source change
            }
        }
        ...
        public async void SearchCriteriaProducts(string field, string value)
        {
            ...
            else
            {
                ...
                frmProducts.DefInstance.dcProducts.RecordSource = modConnection.RecordSource;//gap-note line added due to Binding Source change
                frmProducts.DefInstance.VB6_AddADODataBinding(true);//gap-note line added due to Binding Source change
            }
        }

        public async void SearchCriteriaProviders(string field, string value)
        {
            ...
            else
            {
                ...
                frmProviders.DefInstance.dcProviders.RecordSource = modConnection.RecordSource;//gap-note line added due to Binding Source change
                frmProviders.DefInstance.VB6_AddADODataBinding(true);//gap-note line added due to Binding Source change
            }
        }
