		...
		: Form
	{
		...
		private async void cmdCancel_Click(Object eventSender, EventArgs eventArgs)
		{
			try
			{
				...
				if (await MessageBox.Show("Do you want to cancel the order request?", "Confirm cancellation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.Yes)
				{
					return;
				}
