namespace SKS_Blazor.Components
{
    ...
    public partial class frmAddStockManual : Form
    {

        public frmAddStockManual(): base()
        {
        ...
        private async void cmdSave_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            try
            {
                ...
                if (await MessageBox.Show($"Data added successfully{Environment.NewLine}Would you like to add a new stock manually?", "New data", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ClearFields();
                }
                else
        ...
        private async void RetrieveDataProduct()
        {
            ...
            if (!(lvProducts.FocusedItem is null))
            {
                ...
                currentPriceReference = Double.Parse(ListView.GetListViewSubItem(withVar, 2).Text);
